<div>
    ...
    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
        ...
        <div class="dropdown-item d-flex align-items-center">
            ...
            <div class="flex-grow-1">
                ...
                <small>{{ $item['quantidade'] }}x R$
                    {{ App\Helpers\FormatHelper::brl($item['preco_unitario']) }}
                </small>
            </div>
            <button wire:click="removerItem('{{ $item['nome'] }}')" class="btn btn-sm btn-outline-danger ml-2"
                title="Remover item">
        ...
        <a href="{{ route('carrinho.confirmar') }}" class="dropdown-item dropdown-footer">
            Confirmar compra
        </a>
    </div>
</div>