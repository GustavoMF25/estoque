        ...
        <div class="card-body">
            ...
            <div class="mt-5">
                @if (!$this->enabled)
                    ...
                    <x-modal-new wire:then="enableTwoFactorAuthentication" id="modalExample" title="Confirmação" :confirmButton="['id' => 'confirmBtn', 'label' => 'Confirmar']">
                        <div wire:model.live="confirmingPassword">
                           {{ __('Confirm Password') }}
                    ...
                    <button onclick="abrirModal('modalExample')" class="btn btn-block btn-outline-primary"
