<x-basic.content-page :title="__('Add Team Member')" :class="'card-primary'">
    @if (Gate::check('addTeamMember', $team))
        <x-section-border />

        <!-- Add Team Member -->
        <div class="mt-10 sm:mt-0">
            <form submit="addTeamMember">
                                    ...
                                    <x-button :type="'button'"
                                        ...
                                        <div
                                            ...
                                            <div class="flex items-center">
                                                <div
                                                    class="d-flex text-center justify-content-center {{ $addTeamMemberForm['role'] == $role->key ? 'font-semibold' : '' }}">
