        ...
        <div class="container">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <div>
                    ...
                    <p class="text-muted mb-0">Eventos registrados no banco de dados.</p>
                </div>
            ...
            <form method="GET" class="row g-3 mb-4">
                <div class="col-md-4">
                    ...
                    <input type="text" name="action" value="{{ $filters['action'] ?? '' }}" class="form-control"
                        placeholder="ex.: produto.created">
                </div>
                <div class="col-md-3">
                    <label class="form-label">Usuário (ID)</label>
                    <input type="number" min="1" name="user" value="{{ $filters['user'] ?? '' }}" class="form-control">
                </div>
                    ...
                    <tbody>
                        @forelse ($logs as $log)
                            <tr>
                                ...
                                <td>
                                    <pre class="mb-0 small">{{ json_encode($log->details, JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE) }}</pre>
                                </td>
